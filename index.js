...
function hideThirdText () {
    var x = document.getElementById("third-section-list");
    if (x.style.display == "none") {
        x.style.display = "block";
        document.getElementById("third-section-button").innerHTML = "Hide List";
    } else {
        x.style.display = "none";
        document.getElementById("third-section-button").innerHTML = "Reveal List";
    }
}
